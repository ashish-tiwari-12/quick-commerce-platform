    ...
    <div className='fixed top-0 bottom-0 right-0 left-0 z-50 bg-neutral-800 bg-opacity-40 p-4 flex justify-center items-center animate-fadeIn'>
      <div className='bg-white w-full max-w-md p-6 rounded-2xl shadow-2xl transform transition-all'>
           ...
           <div className='flex justify-end items-center gap-3'>
                ...
                <button onClick={confirm} className='px-6 py-2.5 border-2 rounded-lg border-green-600 bg-primary text-white hover:bg-primary-hover hover:border-green-700 font-semibold transition-all duration-200 hover:shadow-md'>Confirm</button>
           </div>
      </div>
    </div>
  )
